...
class Bittrex(object):
    ...
    def withdraw(self, currency, quantity, address, address_tag):
        """
        ...
        :type address: str
        :param address_tag: The address tag for XLM, XRP, XMR, and maybe others.
        ...
        }, options={'currency': currency, 'quantity': quantity, 'address': address, 'paymentid': address_tag}, protection=PROTECTION_PRV)
